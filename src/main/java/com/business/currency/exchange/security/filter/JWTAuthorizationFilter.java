package com.business.currency.exchange.security.filter;

import com.business.currency.exchange.security.constants.JwtConstants;
...
public class JWTAuthorizationFilter extends OncePerRequestFilter {
    ...
    Claims validateToken(HttpServletRequest request) {
        ...
        return Jwts.parser().setSigningKey(Keys.hmacShaKeyFor(JwtConstants.SECRET.getBytes())).parseClaimsJws(jwtToken).getBody();
    }
